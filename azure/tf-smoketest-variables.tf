resource "kubernetes_config_map" "terraform-variables" {
  # this file is generated via pre-commit, DO NOT EDIT !
    ...
    dev_openai_api_key = "${jsonencode(var.dev_openai_api_key)}"
    dev_openai_api_url = "${jsonencode(var.dev_openai_api_url)}"
    prod_openai_api_key = "${jsonencode(var.prod_openai_api_key)}"
    prod_openai_api_url = "${jsonencode(var.prod_openai_api_url)}"
    backup_openai_api_key = "${jsonencode(var.backup_openai_api_key)}"
    backup_openai_api_url = "${jsonencode(var.backup_openai_api_url)}"
