...
locals {
  ...
  environment_cluster_cluster_endpoint                  = var.load_environment == "" ? module.cluster[0].cluster_endpoint : data.terraform_remote_state.environment[0].outputs.cluster_cluster_endpoint
