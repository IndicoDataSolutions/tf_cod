...
locals {
  ...
  environment_fsx_rwx_subnet_id               = var.load_environment == "" ? var.include_fsx == true ? module.fsx-storage[0].fsx_rwx_subnet_ids[0] : "null" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_subnet_ids[0]
  ...
  environment_fsx_rwx_mount_name              = var.load_environment == "" ? var.include_fsx == true ? module.fsx-storage[0].fsx_rwx_mount_name : "null" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_mount_name
  environment_fsx_rwx_volume_handle           = var.load_environment == "" ? var.include_fsx == true ? module.fsx-storage[0].fsx_rwx_id : "null" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_id
  environment_fsx_rwx_dns_name                = var.load_environment == "" ? var.include_fsx == true ? module.fsx-storage[0].fsx_rwx_dns_name : "null" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_dns_name
