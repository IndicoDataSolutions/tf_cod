...
locals {
  ...
  environment_efs_filesystem_id               = var.load_environment == "" ? var.include_efs == true ? coalesce(module.efs-storage[0].efs_filesystem_id, "null") : "" : data.terraform_remote_state.environment[0].outputs.efs_filesystem_id
  environment_fsx_rwx_id                      = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_id, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_id
  environment_fsx_rwx_arn                     = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_arn, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_arn
  environment_fsx_rwx_subnet_ids              = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_subnet_ids, [])  : [] : data.terraform_remote_state.environment[0].outputs.fsx_rwx_subnet_ids
  environment_fsx_rwx_subnet_id               = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_subnet_ids[0], "null")   : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_subnet_ids[0]
  environment_fsx_rwx_security_group_ids      = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_security_group_ids, []) : [] : data.terraform_remote_state.environment[0].outputs.fsx_rwx_security_group_ids
  environment_fsx_rwx_mount_name              = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_mount_name, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_mount_name
  environment_fsx_rwx_volume_handle           = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_id, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_id
  environment_fsx_rwx_dns_name                = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rwx_dns_name, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rwx_dns_name
  environment_fsx_rox_id                      = var.load_environment == "" ? var.include_fsx == true ? coalesce(module.fsx-storage[0].fsx_rox_id, "null") : "" : data.terraform_remote_state.environment[0].outputs.fsx_rox_id
