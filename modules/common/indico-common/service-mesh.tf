...
resource "helm_release" "linkerd-crds" {
  ...
  name             = "linkerd-crds"
  chart            = var.use_local_helm_charts ? "./charts/linkerd-crds/linkerd-crds.tgz" : "linkerd-crds"
...
resource "helm_release" "linkerd-control-plane" {
  ...
  chart      = var.use_local_helm_charts ? "./charts/linkerd-control-plane/linkerd-control-plane.tgz" : "linkerd-control-plane"
  namespace  = var.service_mesh_namespace
  repository = var.use_local_helm_charts ? null : var.helm_registry
...
resource "helm_release" "linkerd-viz" {
  ...
  name       = "linkerd-viz"
  chart      = var.use_local_helm_charts ? "./charts/linkerd-viz/linkerd-viz.tgz" : "linkerd-viz"
  namespace  = var.service_mesh_namespace
  repository = var.use_local_helm_charts ? null : var.helm_registry
...
resource "helm_release" "linkerd-multicluster" {
  ...
  chart      = var.use_local_helm_charts ? "./charts/linkerd-multicluster/linkerd-multicluster.tgz" : "linkerd-multicluster"
