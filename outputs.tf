...
output "indico_ipa_topic_arn" {
  value = local.environment.indico_ipa_topic_arn
}

output "indico_ipa_queue_arn" {
  value = local.environment.indico_ipa_queue_arn
}

output "indico_sqs_sns_policy_name" {
  value = local.environment.indico_sqs_sns_policy_name
}

## KMS outputs

output "kms_key_arn" {
  value = local.environment.kms_key_arn
}

output "kms_key" {
  value = local.environment.kms_key
}
...
output "api_models_s3_bucket_name" {
  ...
  value       = local.environment.api_models_s3_bucket_name
}

output "data_s3_bucket_name" {
  description = "Name of the data s3 bucket"
  value       = local.environment.data_s3_bucket_name
}

output "pgbackup_s3_bucket_name" {
  description = "Name of the pgbackup s3 bucket"
  value       = local.environment.pgbackup_s3_bucket_name
}

output "miniobkp_s3_bucket_name" {
  description = "Name of the miniobkp s3 bucket"
  value       = local.environment.miniobkp_s3_bucket_name
}
...
output "efs_filesystem_id" {
  ...
  value       = local.environment.efs_filesystem_id
}
...
output "cluster_role_name" {
  ...
  value       = local.environment.cluster_role_name
}


output "cluster_role_arn" {
  description = "ARN of the EKS cluster IAM role"
  value       = local.environment.cluster_role_arn
}

output "node_role_name" {
  description = "Name of the EKS node IAM role"
  value       = local.environment.node_role_name
}

output "node_role_arn" {
  description = "ARN of the EKS node IAM role"
  value       = local.environment.node_role_arn
}

output "s3_backup_role_name" {
  description = "Name of the S3 backup IAM role"
  value       = vlocal.environment.s3_backup_role_name
}

output "s3_backup_role_arn" {
  description = "ARN of the S3 backup IAM role"
  value       = local.environment.s3_backup_role_arn
}

output "s3_replication_role_name" {
  description = "Name of the S3 replication IAM role"
  value       = local.environment.s3_replication_role_name
}

output "s3_replication_role_arn" {
  description = "ARN of the S3 replication IAM role"
  value       = local.environment.s3_replication_role_arn
}

output "vpc_flow_logs_role_name" {
  description = "Name of the VPC flow logs IAM role"
  value       = local.environment.vpc_flow_logs_role_name
}

output "vpc_flow_logs_role_arn" {
  description = "ARN of the VPC flow logs IAM role"
  value       = local.environment.vpc_flow_logs_role_arn
}
...
output "nginx_ingress_security_group_id" {
  value = local.environment.nginx_ingress_security_group_id
}

output "nat_gateway_eips" {
  value = local.environment.nat_gateway_eips
}

output "nginx_ingress_allowed_cidrs" {
  value = local.environment.nginx_ingress_allowed_cidrs
}
