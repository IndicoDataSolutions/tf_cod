resource "kubernetes_config_map" "terraform-variables" {
  ...
  data = {
    ...
    harbor_pull_secret_b64 = "${jsonencode(var.harbor_pull_secret_b64)}"
    applications = "${jsonencode(var.applications)}"
    region = "${jsonencode(var.region)}"
    aws_access_key = "${jsonencode(var.aws_access_key)}"
    aws_secret_key = "${jsonencode(var.aws_secret_key)}"
    ...
    argo_username = "${jsonencode(var.argo_username)}"
    argo_password = "${jsonencode(var.argo_password)}"
    ...
    opentelemetry-collector_version = "${jsonencode(var.opentelemetry-collector_version)}"
    ...
    crds-values-yaml-b64 = "${jsonencode(var.crds-values-yaml-b64)}"
    pre-reqs-values-yaml-b64 = "${jsonencode(var.pre-reqs-values-yaml-b64)}"
