...
node_groups = {
  gpu-workers = {
    min_size               = 0
    max_size               = 5
    instance_types         = ["g4dn.xlarge"] # 1 GPU, 4 CPU, 16GiB Memory
    type                   = "gpu"
    spot                   = false
    desired_capacity       = "0"
  ...
  celery-workers = {
    min_size         = 0
    max_size         = 20
    instance_types   = ["m5.xlarge"] # 4 CPU, 16GiB Memory
    type             = "cpu"
    spot             = false
    desired_capacity = "0"
  ...
  highmem-workers = {
    min_size         = 0
    max_size         = 3
    instance_types   = ["m5.2xlarge"] # 8 CPU, 32GiB Memory
    type             = "cpu"
    spot             = false
    desired_capacity = "0"
  ...
  monitoring-workers = {
    min_size         = 1
    max_size         = 4
    instance_types   = ["m5.large"] # 2 CPU, 8GiB Memory
    type             = "cpu"
    spot             = false
    desired_capacity = "1"
